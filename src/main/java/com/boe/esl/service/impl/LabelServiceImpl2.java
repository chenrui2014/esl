...
import com.boe.esl.service.LabelService2;

@Service
@Transactional
public class LabelServiceImpl2 implements LabelService2 {
	...
	@Override
	public Label findByMac(String mac) {
		return labelRepository.findByMac(mac);
	}
