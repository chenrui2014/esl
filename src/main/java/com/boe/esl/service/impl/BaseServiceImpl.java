...
import com.boe.esl.model.AbstractBaseModel;
import com.boe.esl.model.BaseModel;
import com.boe.esl.model.MarkDeleteableModel;
import com.boe.esl.service.BaseService;
import com.boe.esl.vo.BaseVO;

@SuppressWarnings("unchecked")
public abstract class BaseServiceImpl<T extends BaseModel<ID>, ID extends Serializable, V extends BaseVO> implements BaseService<T, ID,V> {

	private VOConverter converter;
	
    public final VOConverter getConverter() {
		return converter;
	}
    @Autowired
	public final void setConverter(VOConverter converter) {
    ...
    public List<T> list(final Map<String, Object> params) {
        Specification<T> spec = new Specification<T>() {  
			 ...
			 */
			private static final long serialVersionUID = -5373416912710546877L;
    ...
    public Page<T> list(final Map<String, Object> params,Pageable pageable){
        Specification<T> spec = new Specification<T>() {  
			 ...
			 * @field serialVersionUID:TODO()
			 */
			private static final long serialVersionUID = -41003062146803466L;
